...
function buildTheme(mode = "light") {
  ...
  const base = createTheme({
    palette: {
      ...
      background: {
        default: mode === "light" ? "#f6f4ec" : "#0b1220",
    ...
    typography: {
      fontFamily: `'Montserrat', system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji`,
  ...
  // 2) Add component defaults/overrides
  ...
  return (
    <GlobalStyles
      styles={(theme) => ({
        ...
        ":root": {
          "--radius": `${radii.xs}px`,
          "--btn-py": theme.spacing(1.0),
          "--btn-px": theme.spacing(2.0),
        },
